This is a bookmarklet used to unblur obfuscated content such as phone numbers, email addresses, etc. It can be used for search results on sites like thatsthem, Intelius, zabasearch, etc.
